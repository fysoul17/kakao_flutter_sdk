...
/**
 * fetchUserOrCreate - Create a new user if email is not given, since there is no other way to map users.
 ...
 * @return {Promise<UserRecord>}
 */
export const linkUserWithKakao = async function (kakaoUserId: number, userRecord: UserRecord): Promise<UserRecord> {
